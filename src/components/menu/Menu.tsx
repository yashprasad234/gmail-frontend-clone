  ...
  return (
    <div className={`flex flex-col p-4 ${expanded ? "w-60" : "w-28"} sticky`}>
      <div className={`flex p-4 gap-4 bg-blue-100 rounded-2xl w-4/5`}>
        ...
        {expanded && <p className="text-lg">Compose</p>}
      </div>
      <div>
        <button
          className={`flex gap-4 ${
            expanded
              ? "hover:rounded-r-3xl px-4 py-2 w-full"
              : "hover:rounded-full p-2"
          } hover:bg-slate-100 active:bg-blue-100`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
