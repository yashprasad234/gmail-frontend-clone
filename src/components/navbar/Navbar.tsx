export default function Navbar() {
  return (
    <div className="flex py-2 px-4 justify-between items-center">
      ...
      <div className="flex items-center justify-center bg-slate-100 rounded-3xl w-3/5 p-4 justify-between ml-16">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
          fill="currentColor"
      ...
      <div className="flex justify-between items-center">
        ...
        <button className="rounded-full text-xl text-white bg-blue-500 px-4 py-2">
          Y
        </button>
      </div>
    </div>
